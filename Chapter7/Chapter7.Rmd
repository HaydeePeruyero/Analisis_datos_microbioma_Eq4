...
El principal objetivo de la ordenación fue la "exploración" con la introducciónm de un análisis canónico de correspondencia (CCA), la ordenación ha ido más allá de meramente un análisis "exploratorio" y se ha convertido en una prueba de hipótesis.
