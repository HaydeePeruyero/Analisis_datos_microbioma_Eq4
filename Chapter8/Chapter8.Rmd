...
#Diagrama de caja de Bacteroides bacterianos con grupos Vdr-/- y WT en muestras fecales
...
#el argumento bidwith=2 genera un error
```
Los diagramas de caja muestran taxones (**Bacteriodes**) en ratones de tipo salvaje (WT, n = 3) y para ratones  knockout de Vdr (KO, n = 5)
...
```{r}
#tabla 1
#Distribution of the Parabacteroides rate across Vdr−/− and WT cecal samples obtained
abund_table[1:16,1:27]
(Parabacteroides <- abund_table[,27])
```
Luego, combine los datos subdivididos con el marco de datos de agrupación.
